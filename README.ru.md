...
[![CI](https://github.com/kiselyovd/cardio-risk-rf/actions/workflows/ci.yml/badge.svg)](https://github.com/kiselyovd/cardio-risk-rf/actions/workflows/ci.yml)
...
Тип задачи: `tabular` · Фреймворк: `sklearn`.
